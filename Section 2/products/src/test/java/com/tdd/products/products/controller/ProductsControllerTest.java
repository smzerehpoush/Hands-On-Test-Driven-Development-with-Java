...
class ProductsControllerTest {
    ...
    void testGetProductByIdFindsProduct() throws Exception {
        ...
        doReturn(Optional.of(mockProduct)).when(productService).findById(mockProduct.getId());
    ...
    void testUpdatingProductWithSuccess() throws Exception {
        // Prepare mock product
        ...
        doReturn(mockProduct).when(productService).update(any());
    ...
    void testProductNotFoundWhileUpdating() throws Exception {
        // Prepare mock product
        Product productToUpdate = new Product("New name", "New description", 20);
    ...
    void testProductDeletedSuccessfully() throws Exception {
        // Prepare mock product
        Product existingProduct = new Product(1, "New name", "New description", 20, 1);

        // Prepare mock service method
        doReturn(Optional.of(existingProduct)).when(productService).findById(1);
    ...
    void testFailureToDeleteNonExistingProduct() throws Exception {
        // Prepare mock service method
        doReturn(Optional.empty()).when(productService).findById(1);
